        ...
        <div class="pt-6 border-t">
            <div class="flex space-x-4">
                <button type="submit" class="px-3 py-2 bg-natuur_groen text-witte_eend
                        ...
                        focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Route Aanmaken
                </button>
                <x-button href="{{ route('routes.index') }}" class="px-3 py-2 bg-natuur_groen text-witte_eend
                          font-semibold rounded
                          hover:bg-lnatuur_groen
                          focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Terug
                </x-button>
            </div>
        </div>
    </form>
