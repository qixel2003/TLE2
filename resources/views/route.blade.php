...
<head>
    ...
    <title>Informatie over route: {{ $route['name'] ?? 'Route' }}</title>
...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="p-6 md:p-8">
            <div class="mb-6">
                <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-2">{{ $route['name'] ?? 'Route' }}</h1>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('routes.index') }}"
                       class="flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg text-center transition duration-200 shadow-md hover:shadow-lg">Terug naar overzicht</a>
                </div>
            </div>
        </div>
    </div>
